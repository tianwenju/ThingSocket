 ...
 *
 * @author :  Wenju.Tian
 * @version date : 2017/10/20 14:57
 */


class ThingsDecoder implements ProtocolDecoder {
    ...
    private static String CONTEXT = ThingsDecoder.class.getName() + ".context";

    // 构造函数，必须指定Charset和文本分隔符
    public ThingsDecoder(Charset charset, String delimiter) {
